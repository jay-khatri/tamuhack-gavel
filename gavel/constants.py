...
Welcome to TAMUhack's judging system powered by Gavel.
...
DEFAULT_EMAIL_SUBJECT = 'TAMUhack Judging'

DEFAULT_EMAIL_BODY = '''
Hi {name},

Thank you for being a TAMUhack judge. This email contains your magic link to the judging system.
